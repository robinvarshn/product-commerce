...
const ElectronicCategory = ({ productname, ...props }: { productname: string }) => {
...
export const getServerSideProps: GetServerSideProps = async (
    ...
    let imagePath = `${process.env.NEXT_AEM_PRODUCT_PATH}electronic/${productName}/product-images`;
    let infoPath = `${process.env.NEXT_AEM_PRODUCT_PATH}electronic/${productName}/tabinfo`;
